RegisterCommand("testnpc", function()
    ...
    local npc = exports['talkNPC']:CreateNPC({
        npc = 'u_m_y_abner',
        ...
        [1] = {
            ...
            shouldClose = false,
            action = function()
                exports['talkNPC']:updateMessage("It is a team that creates scripts for FiveM")
            end
        },
        [2] = {
            ...
            shouldClose = false,
            action = function()
                exports['talkNPC']:changeDialog( "We have clean and dirty jobs, which one do you want to choose?",
                    {
                        [1] = {
                            label = "Clean jobs",
                            shouldClose = true,
